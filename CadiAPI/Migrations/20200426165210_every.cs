...
{
    public partial class every : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalValue = table.Column<double>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetPass = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdditionalId = table.Column<int>(nullable: false),
                    ProductId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalProducts", x => new { x.AdditionalId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_AdditionalProducts_Additionals_AdditionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OptionsProducts", x => new { x.OptionsId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_OptionsProducts_Options_OptionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CashierOrders_Cashiers_CashierId",
                        column: x => x.CashierId,
                        principalTable: "Cashiers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CashierOrders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashierOrders_CashierId",
                table: "CashierOrders",
                column: "CashierId");

            migrationBuilder.CreateIndex(
                name: "IX_CashierOrders_OrderId",
                table: "CashierOrders",
                column: "OrderId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_AdditionalId",
                table: "OrderItems",
                column: "AdditionalId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OptionsId",
                table: "OrderItems",
                column: "OptionsId");
